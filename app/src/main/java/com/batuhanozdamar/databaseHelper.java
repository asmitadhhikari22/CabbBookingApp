...
public class databaseHelper extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME="carDatabase";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        try {
            sqLiteDatabase.execSQL(reservationDB.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        try {
            sqLiteDatabase.execSQL(reservationDB.DROP_TABLE_SQL);
    ...
    public Cursor getAllRecordsMethod2(String sql , String...where){
        Cursor cursor = db.rawQuery("select * from "+ reservationDB.TABLE_NAME,where);
        Log.d("DATABASE OPERATIONS", "GET THE RECORDS");
